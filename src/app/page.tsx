  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-yellow-900/20 rounded-lg p-2 border border-yellow-500/20 text-xs">
        ...
        <p className="text-gray-400 mt-1">
          8 РїР»Р°РЅРµС‚ РѕР±СЂР°С‰Р°СЋС‚СЃСЏ РІРѕРєСЂСѓРі РЎРѕР»РЅС†Р°. Р’РЅСѓС‚СЂРµРЅРЅРёРµ вЂ”
          РєР°РјРµРЅРёСЃС‚С‹Рµ (РњРµСЂРєСѓСЂРёР№, Р’РµРЅРµСЂР°, Р—РµРјР»СЏ, РњР°СЂСЃ),
          РІРЅРµС€РЅРёРµ вЂ” РіР°Р·РѕРІС‹Рµ РіРёРіР°РЅС‚С‹ (Р®РїРёС‚РµСЂ, РЎР°С‚СѓСЂРЅ, РЈСЂР°РЅ,
          РќРµРїС‚СѓРЅ).
        </p>
        <p className="text-cyan-400 mt-1">
          РџРµСЂРёРѕРґ РѕР±СЂР°С‰РµРЅРёСЏ Р—РµРјР»Рё = 1 РіРѕРґ. РќРµРїС‚СѓРЅ РґРµР»Р°РµС‚
          РѕР±РѕСЂРѕС‚ Р·Р° ~165 Р»РµС‚!
        </p>
      </div>
    </div>
  )
    ...
    <div className="space-y-3">
      ...
      <div className="bg-blue-900/20 rounded-lg p-3 border border-blue-500/20 text-xs">
        <div className="text-blue-300 font-semibold mb-1">
          рџЊЎпёЏ Р РµР»РёРєС‚РѕРІРѕРµ РёР·Р»СѓС‡РµРЅРёРµ (CMB)
        </div>
        <p className="text-gray-400">
          РљРѕСЃРјРёС‡РµСЃРєРёР№ РјРёРєСЂРѕРІРѕР»РЅРѕРІС‹Р№ С„РѕРЅ вЂ” СЌС‚Рѕ СЃРІРµС‚,
          РёСЃРїСѓС‰РµРЅРЅС‹Р№ ~380 000 Р»РµС‚ РїРѕСЃР»Рµ Р‘РѕР»СЊС€РѕРіРѕ РІР·СЂС‹РІР°, РєРѕРіРґР°
          Р’СЃРµР»РµРЅРЅР°СЏ СЃС‚Р°Р»Р° РїСЂРѕР·СЂР°С‡РЅРѕР№. РўРµРјРїРµСЂР°С‚СѓСЂР° 2.725 K СЃ
          С„Р»СѓРєС‚СѓР°С†РёСЏРјРё ~10вЃ»вЃµ.
        </p>
        <p className="text-cyan-400 mt-1">
          РР·СѓС‡РµРЅРѕ СЃРїСѓС‚РЅРёРєР°РјРё COBE, WMAP, Planck вЂ” РїРѕРґС‚РІРµСЂР¶РґР°РµС‚
          С‚РµРѕСЂРёСЋ Р‘РѕР»СЊС€РѕРіРѕ РІР·СЂС‹РІР°!
        </p>
      </div>
    </div>
  )
...
function DarkEnergyVisualization() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      ctx.fillText(
        `РЈСЃРєРѕСЂРµРЅРёРµ: +${(expansionRate * 100).toFixed(0)}%`,
        width - 125,
        height - 18
      )
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-purple-900/20 rounded-lg p-3 border border-purple-500/20 text-xs">
        ...
        <p className="text-gray-400">
          Р—Р°РіР°РґРѕС‡РЅР°СЏ СЃРёР»Р°, СЃРѕСЃС‚Р°РІР»СЏСЋС‰Р°СЏ ~68% Р’СЃРµР»РµРЅРЅРѕР№ Рё
          РІС‹Р·С‹РІР°СЋС‰Р°СЏ СѓСЃРєРѕСЂРµРЅРЅРѕРµ СЂР°СЃС€РёСЂРµРЅРёРµ. РћС‚РєСЂС‹С‚Р° РІ 1998 Рі.
          (РќРѕР±РµР»РµРІСЃРєР°СЏ РїСЂРµРјРёСЏ 2011). РџСЂРёСЂРѕРґР° РЅРµРёР·РІРµСЃС‚РЅР° вЂ”
          РІРѕР·РјРѕР¶РЅРѕ, СЌРЅРµСЂРіРёСЏ РІР°РєСѓСѓРјР° РёР»Рё РјРѕРґРёС„РёРєР°С†РёСЏ
          РіСЂР°РІРёС‚Р°С†РёРё.
        </p>
        <p className="text-cyan-400 mt-1">
          Р‘РµР· РЅРµС‘ РіР°Р»Р°РєС‚РёРєРё СЂР°Р·Р±РµРіР°Р»РёСЃСЊ Р±С‹ РјРµРґР»РµРЅРЅРµРµ!
        </p>
      </div>
    </div>
  )
