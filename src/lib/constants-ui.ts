export const NAV_ITEMS = [
  ...
  { id: "thermodynamics", label: "thermodynamics", color: "from-green-600 to-blue-600" },
  { id: "advanced", label: "advanced", color: "from-pink-600 to-purple-600" },
] as const

export const SECTIONS = ["quantum", "relativity", "cosmos", "thermodynamics", "advanced"] as const
